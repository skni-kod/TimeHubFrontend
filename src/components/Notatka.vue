<template>
  <div class="kontenerNotatki">
    <div class="kontenerTytulowyNotatki">
      <div class="tytulNotatki">{{ props.tytul }}</div>
    ...
    <textarea class="zawartoscNotatki" oninput='this.style.height = "";this.style.height = this.scrollHeight + "px"' v-text='props.zawartosc'/>
  </div>
</template>
